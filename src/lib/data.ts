...
export const PRODUCTS: Product[] = [
  ...
  /* ---------------- 10 · GRC PLANTERS & LANDSCAPE ---------------- */
  {
    slug: "grc-planters",
    code: "BSP-10",
    family: "GRC",
    name: "GRC Planters & Landscape",
    navLabel: "Planters",
    registerLine: "Planters, tree grates and landscape pieces cast to age well.",
    hero: {
      kicker: "PREMIUM GRC ARCHITECTURAL PRODUCTS",
      lines: [
        { text: "GRC Planters —" },
        { text: "Built-In Green,", underline: true },
        { text: "Built to Last." },
      ],
      sub: "Frost-proof, root-safe GRC planters, tree grates and landscape elements that age gracefully through sun and monsoon.",
      media: "drawing",
      drawingVariant: "square",
      stamp: "DWG NO. BSP-PL-01",
      dimLabel: "300–1800 MM LENGTHS",
      tag: {
        kicker: "SPEC 10-A · LINER",
        title: "Root-barrier cast into the wall",
        body: "A sealed inner face keeps roots and moisture where they belong — in the soil.",
      },
      watermark: "GREENS",
    },
    ticker: [
      "FROST-PROOF · ROOT-SAFE",
      "SELF-WEIGHTED — NO TIPPING",
      "300–1800 MM LENGTHS",
      "STONE-LIKE FINISHES",
      "PLANTERS · TREE GRATES · BOLLARDS",
      "DRAINAGE PORTS CAST-IN",
      "TERRACE-SAFE WEIGHTS",
    ],
    features: [
      {
        icon: "leaf",
        title: "Frost & Root Safe",
        lead: "Made for living things",
        points: [
          "Sealed inner face stops root penetration",
          "Frost-proof shell survives freeze cycles",
          "Cast-in drainage ports with gravel sumps",
        ],
        note: "ROOT-BARRIER INNER FACE",
      },
      {
        icon: "wall",
        title: "Self-Weighted Stability",
        lead: "Planted, and it stays put",
        points: [
          "Enough mass to resist wind and nudges — no tipping",
          "Terrace-weight options when every kg counts",
          "Bollard-grade impact resistance at edges",
        ],
        note: "TIP-TESTED AT 45° LEAN",
      },
      {
        icon: "trowel",
        title: "Finish Variety",
        lead: "Stone looks, concrete honesty",
        points: [
          "Exposed aggregate, sandstone and basalt textures",
          "Any RAL colour cast-in for branded landscapes",
          "Ages to a natural patina outdoors",
        ],
        note: "6 STANDARD TEXTURES",
      },
    ],
    applications: [
      { icon: "villa", title: "Villas & Terraces", desc: "Signature planters for entry courts, terraces and pool decks.", chip: "ENTRY & TERRACE" },
      { icon: "tower", title: "Hotels & Resorts", desc: "Landscape pieces that survive housekeeping and monsoon alike.", chip: "HOSPITALITY" },
      { icon: "tree", title: "Public Plazas", desc: "Tree grates, guards and street planters built for civic abuse.", chip: "STREET FURNITURE" },
      { icon: "tower", title: "Corporate Campuses", desc: "Branded planter lines for lobbies, podiums and promenades.", chip: "CAMPUS GREENS" },
    ],
    familyLabel: "GRC PLANTER",
    familyDim: "300–1800 MM",
    showcaseCols: "2/3/4",
    showcase: [
      {
        variant: "square",
        ...
        name: "Square Planter",
        tag: "BEST SELLER",
        dimLabel: "450–1200 MM",
        desc: "The tapered square classic with a shadow-line rim — the default for entries and terraces.",
        specs: ["450–1200 mm square", "Tapered with rim detail", "Drainage port cast-in"],
      },
      {
        variant: "urn",
        code: "BSP-PL-02",
        name: "Urn Planter",
        dimLabel: "Ø 400–900 MM",
        desc: "A classical urn on a plinth foot — instant stature for porches and courtyards.",
        specs: ["Ø 400–900 mm", "Plinth foot included", "Relief-band options"],
      },
      {
        variant: "raised",
        code: "BSP-PL-03",
        name: "Linear Raised Bed",
        tag: "TRENDING",
        dimLabel: "LENGTHS TO 1800 MM",
        desc: "Long, low beds that edge lawns and podiums — linkable into runs of any length.",
        specs: ["Modules to 1800 mm", "Linkable corner pieces", "Bench-height options"],
      },
      {
        variant: "treegrate",
        code: "BSP-PL-04",
        name: "Tree Grate & Guard",
        dimLabel: "GRATE 900–1500 MM",
        desc: "Split grates around street trees with matching bollard guards — civic-grade by design.",
        specs: ["Two-piece split grate", "Bollard guards included", "Adjustable inner ring"],
      },
    ],
    comparison: {
      kicker: "02 / WHY SWITCH",
      title: ["THE LANDSCAPE THAT", "STAYS FINISHED."],
      highlight: "GRC PLANTER",
      cols: ["TERRACOTTA", "PLAIN CONCRETE", "CORTEN / METAL"],
      rows: [
        { label: "Frost & sun", cells: ["Frost-proof shell", "Spalls in frost", "Efflorescence stains", "Heats roots in sun"] },
        { label: "Weight handling", cells: ["Light, terrace-safe", "Heavy but fragile", "Very heavy", "Light, but tips"] },
        { label: "Finish life", cells: ["Cast-in, ages well", "Glaze crazes", "Stains & salts", "Rust run-off"] },
        { label: "Impact", cells: ["Bollard-grade", "Shatters", "Chips", "Dents"] },
        { label: "Design life", cells: ["30+ years", "5–8 years", "15 years, ugly stains", "20 years, rusts through"] },
      ],
      note: "* INDICATIVE VALUES FOR A 900 MM SQUARE PLANTER. TEST REPORTS AVAILABLE ON REQUEST.",
    },
    stats: [
      { value: 35000, suffix: "+", label: "Planters installed" },
      { value: 6, suffix: "", label: "Standard textures" },
      { value: 18, suffix: "", label: "States served pan-India" },
      { value: 10, suffix: "-YR", label: "Structural warranty" },
    ],
    process: {
      kicker: "04 / FROM PLANTING PLAN TO PLANTED",
      title: ["FOUR STEPS", "TO A LIVING", "LANDSCAPE."],
      intro: "Send the planting plan or a Pinterest board — we match sizes, textures and counts and deliver palletised.",
      steps: [
        { title: "Share plan & references", desc: "Planting plan, reference images and counts — terrace load limits if it's a roof garden." },
        { title: "Schedule + quote in 24 h", desc: "Per-piece pricing with texture options and a delivery-batched schedule." },
        { title: "Cast & texture", desc: "Planters cast with cast-in colour and textured faces, cured and sealed." },
        { title: "Deliver & place", desc: "Palletised delivery with lifting points; plant straight in through the cast drainage layer." },
      ],
      media: "drawing",
      drawingVariant: "square",
      caption: "SQUARE PLANTER · 900 MM TYPICAL",
    },
    quote: {
      heading: "TELL US YOUR PLAN.",
      sub: "Share pieces, sizes and city — our sales engineer replies with per-piece pricing and texture samples.",
      selects: [
        { label: "PIECE TYPE", options: ["Square Planter", "Urn Planter", "Linear Raised Bed", "Tree Grate & Guard", "Mixed / custom"] },
        { label: "TEXTURE", options: ["Smooth fair-face", "Exposed aggregate", "Sandstone texture", "Basalt texture", "Not sure — send samples"] },
      ],
      qtyLabel: "PIECE COUNT",
      qtyOptions: ["1–10 pieces", "10–50 pieces", "50–200 pieces", "200+ (project supply)"],
    },
  },
];
